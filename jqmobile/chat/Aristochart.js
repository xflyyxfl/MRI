...
var Aristochart = function(element, options, theme) {
	...
	if(window.devicePixelRatio > 1) {
		console.log("fix for retina and other screen resolution:window.devicePixelRatio:" +window.devicePixelRatio );
	...
	//this.resolution = 1;
	first_render=true;
	console.log("this.resolution,first:" + this.resolution);
...
Aristochart.prototype.render = function() {
	console.log("render fun_");
	// Apply the resolution to all the dimensions
	if(!first_render){this.resolution=1;}
	first_render=false;
